...
b_reiniciar.addEventListener('click', (event) => {
	for(var i=0;i<9;i++) {
		...
		casas[i].style.color='#db7f42'; //Torna o valor _ invisível
		casas[i].style.backgroundColor='#db7f42'; //Torna o fundo branco
	}
...
var vitoria = function() {
	if((casas[0].value==casas[1].value) && (casas[1].value==casas[2].value) && casas[0].value!='_' ) {
		casas[0].style.backgroundColor='#ffffff';
		casas[1].style.backgroundColor='#ffffff';
		casas[2].style.backgroundColor='#ffffff';

		return casas[0].value;

	}else if((casas[3].value==casas[4].value) && (casas[4].value==casas[5].value) && casas[3].value!='_' ) {
		casas[3].style.backgroundColor='#ffffff';
		casas[4].style.backgroundColor='#ffffff';
		casas[5].style.backgroundColor='#ffffff';

		return casas[3].value;

	}else if((casas[6].value==casas[7].value) && (casas[7].value==casas[8].value) && casas[6].value!='_' ) {
		casas[6].style.backgroundColor='#ffffff';
		casas[7].style.backgroundColor='#ffffff';
		casas[8].style.backgroundColor='#ffffff';
